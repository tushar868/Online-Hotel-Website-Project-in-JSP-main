...
%>
          <tr>
          <th scope="col" style="background-color: Orange;"><a href="myCart.jsp"><i class='fas fa-arrow-circle-left' style="color:black"> Back</i></a></th>
     ...
     while(rs.next()){
      %>
          <tr style="background-color: #A3BB98">
          <%sno=sno+1; %>
...
<div class="right-div">
<h3>Pay online on this using phone pe or google pay</h3>
