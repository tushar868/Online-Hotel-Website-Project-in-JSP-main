          ...
          <th>Mobile Number</th>
            ...
            <th scope="col">Order Date</th>
             ...
             <th scope="col">Payment Method</th>
              ...
              <th scope="col">Accept Order<i class='fas fa-dolly'></i></i></th>
          </tr>
            ...
            <td><i class="fa fa-inr"></i>  <%=rs.getString(5) %></td>
             ...
             <td><%=rs.getString(11) %></td>
              <td><%=rs.getString(12) %></td>
               ...
               <td><a href="cancelOrdersAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>" style=color:red>Cancel <i class='fas fa-window-close'></i></a></td>
                <td><a href="deliveredOrdersAction.jsp?id=<%=rs.getString(2)%>&email=<%=rs.getString(1)%>" style=color:green>Accepted <i class='fas fa-dolly'></i></i></a></td>
            </tr>
         <%
    	   }
    	   }catch(Exception e){
